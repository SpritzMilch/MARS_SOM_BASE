...
if $DEBUG; then
  ui_print "- DEBUG MODE"
  ui_print "-- MODULE INSTALL LOG WILL INCLUDE DEBUG INFOS!!!!!"
  ui_print "--- MAKE SURE TO SAVE IT AFTER MODULE INSTALL!!!!!"
  set -x
fi

# Extract files
ui_print "- EXTRACTING MARS FILES"
...
ui_print "-- INSTALLING ON A $ARCH SDK $API DEVICE"
